...
class ApiContactTest extends TestCase
{
    ...
    /** @test */
    public function お問い合わせ一覧の_jso_nレスポンス構造が正しい(): void
    {
        // Arrange
    ...
    /** @test */
    public function お問い合わせ一覧の_jso_nレスポンス内容が正しい(): void
    {
        // Arrange
        $category = Category::factory()->create(['content' => 'テストカテゴリー']);
    ...
    /** @test */
    public function 存在しないお問い合わせ_i_dで更新しようとすると404エラーを返す(): void
    {
        // Act
    ...
    /** @test */
    public function お問い合わせを_jso_n形式で削除できる(): void
    {
        // Arrange
        $category = Category::factory()->create();
        $contact = Contact::factory()->create([
    ...
    /** @test */
    public function 存在しないお問い合わせ_i_dで削除しようとすると404エラーを返す(): void
    {
        // Act
