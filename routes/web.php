...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/admin/tags', [AdminController::class, 'index']);
    ...
    Route::put('/admin/tags/{tag}', [TagController::class, 'store'])->name('tags.update');
    Route::delete('/admin/tags/{tag}', [TagController::class, 'update'])->name('tags.update');
});
